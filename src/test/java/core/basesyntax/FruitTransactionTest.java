...
public class FruitTransactionTest {
    ...
    @Test
    public void transactionNegativeQuantity() {
        assertThrows(IllegalArgumentException.class, () ->
